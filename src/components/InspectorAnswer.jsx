...
const InspectorAnswer = ({ content, handleClickEvent }) => {
  ...
  return (
    <div
      className="
      bg-gradient-to-r justify-start text-white items-end flex-col gap-4 2xl:gap-6 max-h-[450px] 2xl:max-h-[1000px] flex from-slate-800/80 drop-shadow-none to-green-600/60 2xl:rounded-2xl 2xl:p-6 rounded-xl p-4"
    >
