...
const InspectorFacts = ({ content }) => {
  ...
  return (
    <div
      className="
      bg-gradient-to-r text-white w-full items-start flex-col h-full gap-16 flex from-slate-600/80 drop-shadow-none to-slate-800/60 rounded-xl 2xl:rounded-2xl 2xl:p-8 p-4"
    >
